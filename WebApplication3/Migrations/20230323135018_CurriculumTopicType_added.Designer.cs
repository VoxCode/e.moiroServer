...
namespace e.moiroServer.Migrations
{
    ...
    [Migration("20230323135018_CurriculumTopicType_added")]
    partial class CurriculumTopicType_added
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DepartmentFinalExamination", b =>
                {
                    b.Property<int>("DepartmentsId")
                        .HasColumnType("integer");
                    ...
                    b.HasKey("DepartmentsId", "FinalExaminationsId");

                    b.HasIndex("FinalExaminationsId");

                    b.ToTable("DepartmentFinalExamination");
                });
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.CurriculumTopic", b =>
                {
                    ...
                    b.Property<int?>("CurriculumTopicTypeId")
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("CurriculumTopicTypeId");
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.CurriculumTopicType", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.CurriculumTopic", b =>
                {
                    b.HasOne("e.moiroServer.Data.Models.CurriculumTopicType", "CurriculumTopicType")
                        .WithMany("CurriculumTopics")
                        .HasForeignKey("CurriculumTopicTypeId");

                    b.Navigation("CurriculumTopicType");
                });
