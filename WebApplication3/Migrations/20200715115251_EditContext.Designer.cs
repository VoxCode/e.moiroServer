...
namespace e.moiroServer.Migrations
{
    ...
    [Migration("20200715115251_EditContext")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.СurriculumTopicConsultationTopics", b =>
                {
                    ...
                    b.HasKey("CurriculumTopicId", "ConsultationTopicsId");
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.СurriculumTopicDepartmens", b =>
                {
                    ...
                    b.HasKey("CurriculumTopicId", "DepartmensId");
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.СurriculumTopicTheQuestions", b =>
                {
                    ...
                    b.HasKey("CurriculumTopicId", "TheQuestionsId");
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.СurriculumTopicTranningProgram", b =>
                {
                    ...
                    b.Property<int>("TranningProgramId")
                        .HasColumnType("integer");

                    b.HasKey("CurriculumTopicId", "TranningProgramId");

                    b.HasIndex("TranningProgramId");

                    b.ToTable("СurriculumTopicTranningProgram");
                });
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.СurriculumTopicDepartmens", b =>
                {
                    b.HasOne("e.moiroServer.Data.Models.CurriculumTopic", "CurriculumTopic")
                        .WithMany("СurriculumTopicDepartmens")
                        .HasForeignKey("CurriculumTopicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("e.moiroServer.Data.Models.СurriculumTopicTranningProgram", b =>
                {
                    b.HasOne("e.moiroServer.Data.Models.CurriculumTopic", "CurriculumTopic")
                        .WithMany("СurriculumTopicTranningPrograms")
                        .HasForeignKey("CurriculumTopicId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("e.moiroServer.Data.Models.TrainingProgram", "TranningProgram")
                        .WithMany("СurriculumTopicTranningPrograms")
                        .HasForeignKey("TranningProgramId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
