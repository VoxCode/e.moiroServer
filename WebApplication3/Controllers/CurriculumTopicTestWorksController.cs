...
namespace e.moiroServer.Controllers
{
    ...
    public class CurriculumTopicTestWorksController : ControllerBase
    {
        ...
        [HttpGet("{id}")]
        public async Task<ActionResult<IEnumerable<CurriculumTopicTestWork>>> Get(int id)
        {
            return await _context.CurriculumTopicTestWorks.Where(a => a.CurriculumTopicId == id).ToListAsync();
        }
